...
Human annotation results, which were used for model training and validation are publicly shared on OSF (https://osf.io/a698g/overview?view_only=221d1f2bc8d34b5d9838354224d6da8f).

## Code Availability

All the processing scripts are also publicly shared on OSF.
